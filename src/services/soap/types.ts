...
interface SoapAccountBrief {
	...
	phone: string;
	mobile: string;
	managerid?: number; // default: -1
	managername?: string; // default: ""
	managerlogin?: string; // default: ""
	organizationid?: number; // default: 0
	organizationname?: string; // default: ""
	orguid?: number; // default: 0
}
interface SoapAgreementBrief {
    agrmid?: number; // default: 0
    defcurr?: number; // default: 0
    isauto?: number; // default: 0
    organizationid?: number; // default: -1
    orgagrmid?: number; // default: -1
    balance?: number; // default: 0
    ppdebt?: number; // default: 0
    number?: string; // default: ""
    symbol?: string; // default: ""
    code?: string; // default: ""
    opername?: string; // default: ""
    closedon?: string; // default: ""
    date?: string; // default: ""
    agreementidbopos?: string; // default: ""
    organizationname?: string; // default: ""
  }
export interface SoapAccountsListItem {
	application?: number;
	account: SoapAccountBrief;
	usergroups?: SoapUsergroupFull[];
	agreements?: SoapAgreementBrief[];
	addresses?: SoapAddressBrief[];
}
